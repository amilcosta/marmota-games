...
//import { toggleStoreGamesAction } from "@/app/actions/storegames"
import { getOffertsDTO, getInfoGameStoreDTO, getInfoGameDTO, getBestOffertsDTO } from '@/lib/switchtwo-deals';
    ...
    return (
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <TopMenuGames allSelected='' switchSelected='' switchTwoSelected='bg-primary' ps4Selected='' ps5Selected=''/>
                {infoGame.length === 0 ? (
                                    ...
                                    <span key={deal.id} className="w-[42%] flex float-right text-primary-foreground bg-secondary round-price mt-1">-{deal.discountPercentage} %</span>
                                        ...
                                        {juegodeals.deals.map((game) => (
                                            <div key={game.id} className="m-auto mt-3 width-info-bottom  flex float-right">
                                                ...
                                                <Button  className="cursor-pointer w-[90%] ml-2 small-font">
                                    ...
                                    <div key={index}> 
                                        ...
                                        {best.deals.map((store, index) => (
                                            <div key={index} className="mt-2">
                                                <Button  className="cursor-pointer w-[90%] ml-2">
