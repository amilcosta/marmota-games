...
import { getOffertsPs5DTO, getInfoGameStorePs5DTO, getInfoGamePs5DTO, getBestOffertsPs5DTO } from '@/lib/ps5-deals';
...
export default async function InfoGamePage({
    ...
    const juegoDeals = await getOffertsPs5DTO(id);
    const storeGames = await getInfoGameStorePs5DTO(id);
    const infoGame   = await getInfoGamePs5DTO(id);
    const bestOffer  = await getBestOffertsPs5DTO(id);
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="text-center py-12">
                    <p className="text-gray-500 text-lg">El juego no existe para la consola</p>
                </div>
                ) : (
                <div className="mb-8">
                                    ...
                                    <CardContent className="medium-bold">
                                        ...
                                        <div key={index}> 
                                            ...
                                            <div className="flex "> Plataforma: 
                                                ...
                                                <svg className="h-[30px] svg-icon svg-platform-nintendo-switch-1 pt-1 pl-2 w-[8%] float-left" >
                                                    {infogame.platformid ==3 ? (
