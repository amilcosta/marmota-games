                      ...
                      <span className="w-[100%] flex">
                        <nav className="w-[70%]">
                          ...
                          {newsps5.deals.map((deal) => (     
                            <img key={deal.id} width="20px" src={newsps5.logoStore} className="ml-2 h-[25px] float-left" title={deal.storeName}/>                             
                          ))}
                        </nav>
                      </span>
                    </AccordionTrigger>
                    ...
                    <span className="w-[100%] flex">
                      <nav className="w-[70%]">
                          ...
                          {bestps5.deals.map((deal) => (     
                            <img key={deal.id} width="20px" src={bestps5.logoStore} className="ml-2 h-[25px] float-left" title={deal.storeName}/>                             
                          ))}
                        </nav>
                    </span>
                  </AccordionTrigger>
