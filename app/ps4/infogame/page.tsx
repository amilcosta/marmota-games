...
import { getOffertsPs4DTO, getInfoGameStorePs4DTO, getInfoGamePs4DTO, getBestOffertsPs4DTO } from '@/lib/ps4-deals';
...
export default async function InfoGamePage({
    ...
    const juegoDeals = await getOffertsPs4DTO(id);
    const storeGames = await getInfoGameStorePs4DTO(id);
    const infoGame   = await getInfoGamePs4DTO(id);
    const bestOffer  = await getBestOffertsPs4DTO(id);
