                    ...
                    <AccordionTrigger className="with-row h-[100%] float-left pl-1 small-font"> 
                      ...
                      <span className="w-[100%] flex">
                            ...
                            {newsdeals.deals.map((deal) => (                               
                                <img key={deal.id} width="20px" src={newsdeals.logoStore} className="ml-2 h-[25px] float-left" title={deal.storeName}/>                                
                              ))}
                            </nav>
                      ...
                      <span className="w-[100%] flex">
                        {bestdeals.platform =='switch1' ? (
                            ...
                            {bestdeals.deals.map((deal) => (                               
                                <img key={deal.id} width="20px" src={bestdeals.logoStore} className="ml-2 h-[25px] float-left" title={deal.storeName}/>                                
                              ))}
                            </nav>
