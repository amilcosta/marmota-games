    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="w-[100%] flex text-secondary-foreground justify-center mb-[2em]">
                    <div className="  w-[70%]">
                        <span className="w-[100%] text-2xl font-bold block text-center"> "El Cofre de la Marmota" </span>
                        <span className="w-[100%] block text-secondary-foreground high-font">
                            <p><strong>El Cofre de la marmota</strong> es una sección que podrá ser visualizada en un grupo privado de Telegram, donde se informará de todo lo que 
                            ofrecerá Marmota Pay de gestion propia. </p>
                            <p>Para poder enterarse de estas novedades, se requiere ser parte del plan Premium, el cual se comenta en la sección Planes, que aparece a continuación</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                            ...
                            <CardContent className="medium-bold">
                                ...
                                <div className="flex mt-2">
                                    ...
                                    <div className="float-left display-block w-[93%]">
                                        ...
                                        en los canales gratis de Telegram que te hayas asociado.</span>
                                    </div>
                                </div>
                                <div className="mt-9">
                                    <a href="https://t.me/+vnfYFsFYYHQ2OGUx" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="w-[100%] mt-12 text-secondary-foreground">
                        <Card className="bg-squirtle-gray rounded-md text-secondary-foreground">
                            ...
                            <CardContent className="medium-bold">
                                <div className="flex text-2xl">CLP $2.500/Mes </div>
                                <div className="flex text-xs text-gray-600">Incluye impuestos </div>
                                <br></br>
                                <hr></hr>
                                <div className="flex mt-2">
                                ...
                                <div className="flex mt-2">
                                    ...
                                    <div className="float-left display-block w-[93%]">
                                    <span className="text-gray-600 pl-1 text-base"> Recibir notificación de  <strong>todos</strong> los videojuegos que han bajado de precio 
                                        en el canal premium de Telegram clasificado por consola de videojuegos, asi como tambien otras categorías.
                                    </span>
                                    </div>
                                </div>
                                <div className="flex mt-2">
                                    ...
                                    <div className="float-left display-block w-[93%]">
                                    <span className="text-gray-600 pl-1 text-base"> Sección "El Cofre de la Marmota"
                                    </span>
                                    </div>
                                </div>
                                <div className="flex mt-2">
                                    ...
                                    <div className="float-left display-block w-[93%]">
                                    <span className="text-gray-600 pl-1 text-base"> Ofertas de Steam en el grupo de Telegram Premium
                                    </span>
                                    </div>
                                </div>
                                <div className="flex mt-2">
